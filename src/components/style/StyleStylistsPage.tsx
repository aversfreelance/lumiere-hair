...
const stylists = [
  { id: 1, name: "Isabella Chen", title: "Creative Director", bio: "15 years crafting bespoke looks for London's fashion elite.", image: "https://images.unsplash.com/photo-1594744803329-e58b31de8bf5?w=600&q=80" },
